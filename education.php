...
<div class="row">
  ...
  <div style="margin: 10px;" class="col-lg-3">
    ...
    <a href="filter.php?search=revision" class="list-group-item">Revision</a>
      <a href="filter.php?search=past_papers" class="list-group-item">Past Papers</a>
      <a href="filter.php?search=code" class="list-group-item">Code</a>
  </div>
  </div>
  </div>
